...
w('src/pages/ApplicationWizardPage.tsx', r"""import React,{useState,useEffect,useRef} from 'react';
...
w('src/pages/ProfilePage.tsx', r"""import React,{useState} from 'react';
...
w('src/pages/ApplicationsPage.tsx', r"""import React,{useEffect,useState} from 'react';
import { useNavigate } from 'react-router-dom';
...
w('src/pages/AdminPage.tsx', r"""import React,{useEffect,useState} from 'react';
import { useNavigate } from 'react-router-dom';
...
w('src/App.tsx', r"""import React from 'react';
